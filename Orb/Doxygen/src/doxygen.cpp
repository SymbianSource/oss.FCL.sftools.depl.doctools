...
void parseInput()
{
  ...
  QCString xmlDitaOutput;
  bool &generateXmlDita = Config_getBool("GENERATE_XML_DITA");
  if (generateXmlDita)
    xmlDitaOutput = createOutputDirectory(outputDirectory,"XML_DITA_OUTPUT","/dita");
  ...
  if (generateXmlDita)   exclPatterns.append(xmlDitaOutput);
...
void generateOutput()
{
  ...
  if (Config_getBool("GENERATE_XML_DITA"))
  {
    msg("Generating XML DITA output...\n");
    generateXMLDITA();
  }
