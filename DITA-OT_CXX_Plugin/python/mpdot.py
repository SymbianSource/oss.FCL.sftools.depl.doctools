...
def invokeDot(theDitaMapPath, theDirOut, argList, isNervous):
    ...
    myCmdList.append(CMD_PREFIX_INPUT+theDitaMapPath)
    myCmdList.append(CMD_PREFIX_OUTPUT+theDirOut)
    myCmdList.append(CMD_PREFIX_TEMP+'temp/%s' % os.path.basename(theDirOut))
